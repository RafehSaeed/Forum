...
public class TopicPost extends Post {
 ...
 public String toString() // toString getcomments should be one method
 {
  String a = "Topic: "+title+"\n";
  a += super.toString();
  a += getComments();//We dont need an extra method to do this as everytime we will print topic all comments will be printed
  return a;
 }
